...
const NavBar = `
		...
		<section class="top-bar-section">
			...
			<li>
				<a href="/pages"><i class="fi-page-add"><span class="show-for-small-only"> Add Page</span></i></a>
			</li>
			<li>
				<a href="/settings"><i class="fi-widget"><span class="show-for-small-only"> Settings</span></i></a>
			</li>
			<li>
				<a href="/logout"><i class="fi-power"><span class="show-for-small-only"> Logout</span></i></a>
			</li>
			</ul>
		</section>
	</nav>
